...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'tournament.context_processors.registration_status',
                'tournament.context_processors.sponsor_info',
            ],
        },
    },
]
...
STATIC_ASSET_VERSION = os.environ.get('STATIC_ASSET_VERSION', 'arena-2026-09-v14')
STORAGES = {
    'staticfiles': {
